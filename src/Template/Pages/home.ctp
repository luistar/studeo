...
<div class="row" >
	<div class="col-md-4">
		...
		<p>
		Studeo is a basic CMS built for university courses. It allows students to share exams and solutions efficiently.
		</p>
	</div>
	<div class="col-md-4">
		<h3 class="page-header"><?=__('May I contribute?')?></h3>
		<p>
		Studeo is free and open source. You may suggest new features or contribute directly on the GitHub page.
		</p>
	...
	<div class="col-md-4">
		...
		<p>
		If you think you found some inaccurate information, please contact the staff and describe the issue.
		</p>
	</div>
</div>
